    ...
    >
      ...
      >
		...
		<SavedDashboardsPanel
		  ...
		  loading={savedDashboardsLoading}
		  onOpen={openSavedDashboard}
		  onRename={renameSavedDashboard}
		  onDelete={removeSavedDashboard}
		/>
        ...
        >
          ...
          >
			<button
			  ...
			  disabled={!generatedDashboard || isSaving}
			  style={{
				border: "none",
				borderRadius: 14,
				background: generatedDashboard
				...
				fontSize: 14,
				fontWeight: 700,
				cursor: generatedDashboard ? "pointer" : "not-allowed",
				boxShadow: generatedDashboard
				  ? "0 10px 20px rgba(5, 150, 105, 0.20)"
				  : "none",
			  }}
			>
